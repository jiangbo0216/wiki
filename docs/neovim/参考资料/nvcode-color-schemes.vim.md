# [NVCode Colorscheme](https://github.com/ChristianChiarulli/nvcode-color-schemes.vim)

主题

[![React pic](nvcode-color-schemes.vim-imgs/react.png)](https://github.com/ChristianChiarulli/nvcode-color-schemes.vim/blob/master/assets/react.png)

**Included Themes**

- nvcode (basically just dark+)
- onedark
- [nord](https://github.com/ChristianChiarulli/nvcode-color-schemes.vim/blob/master/assets/nord.png)
