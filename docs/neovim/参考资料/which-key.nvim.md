...
[![image](which-key.nvim-imgs/116439438-669f8d00-a804-11eb-9b5b-c7122bd9acac.png)](https://user-images.githubusercontent.com/292349/116439438-669f8d00-a804-11eb-9b5b-c7122bd9acac.png)
...
- operators can be configured with the
...
- text objects are automatically retrieved from
...
- motions are part of the preset

   

  ```
  plugins.presets.motions
  ```
...
<details style="box-sizing: border-box; display: block; margin-top: 0px; margin-bottom: 16px; color: rgb(36, 41, 46); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Helvetica, Arial, sans-serif, &quot;Apple Color Emoji&quot;, &quot;Segoe UI Emoji&quot;; font-size: 16px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;"><summary style="box-sizing: border-box; display: list-item; cursor: pointer;">How to disable some operators? (like v)</summary></details>
...
[![image](which-key.nvim-imgs/116439573-8f278700-a804-11eb-80ca-bb9263e6d937.png)](https://user-images.githubusercontent.com/292349/116439573-8f278700-a804-11eb-80ca-bb9263e6d937.png)

### Registers

Shows a list of your buffer local and global registers when you hit " in *NORMAL* mode, or `<c-r>` in *INSERT* mode.

[![image](which-key.nvim-imgs/116439609-98b0ef00-a804-11eb-9385-97c7d5ff4113.png)](https://user-images.githubusercontent.com/292349/116439609-98b0ef00-a804-11eb-9385-97c7d5ff4113.png)

### Presets

Built-in key binding help for `motions`, `text-objects`, `operators`, `windows`, `nav`, `z` and `g`

[![image](which-key.nvim-imgs/116439871-df9ee480-a804-11eb-9529-800e167db65c.png)](https://user-images.githubusercontent.com/292349/116439871-df9ee480-a804-11eb-9529-800e167db65c.png)
...
[![image](which-key.nvim-imgs/118102022-1c361880-b38d-11eb-8e82-79ad266d9bb8.png)](https://user-images.githubusercontent.com/292349/118102022-1c361880-b38d-11eb-8e82-79ad266d9bb8.png)
