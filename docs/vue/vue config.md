...
## [#](https://cli.vuejs.org/zh/config/#全局-cli-配置)全局 CLI 配置
...
- Default: `false`
  ...
  在生成的 HTML 中的 `` 和 `` 标签上启用 [Subresource Integrity](https://developer.mozilla.org/en-US/docs/Web/Security/Subresource_Integrity) (SRI)。如果你构建后的文件是部署在 CDN 上的，启用该选项可以提供额外的安全性。
