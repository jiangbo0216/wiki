...
![img](DNS-imgs/bg2016061501.png)

第一段是查询参数和统计。

![img](DNS-imgs/bg2016061502.png)

第二段是查询内容。

![img](DNS-imgs/bg2016061503.png)

上面结果表示，查询域名`math.stackexchange.com`的`A`记录，`A`是address的缩写。

第三段是DNS服务器的答复。

![img](DNS-imgs/bg2016061504.png)
